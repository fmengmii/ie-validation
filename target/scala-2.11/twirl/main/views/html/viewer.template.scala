...
<!-- 		</select> -->
        ...
        <!--end of new code-->
		"""),_display_(/*267.4*/if(session.containsKey("userName"))/*267.39*/{_display_(Seq[Any](format.raw/*267.40*/("""
			"""),format.raw/*268.4*/("""<text class="userName">User: """),_display_(/*268.34*/session/*268.41*/.get("userName")),format.raw/*268.57*/("""&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</text>
		""")))}),format.raw/*269.4*/("""
	"""),format.raw/*270.2*/("""</div>
	<div id="errorWindow">
		<div>title</div>
        	...
        	<div id='splitter2'>
	        	...
	        	<div id="docSplitPane" style="height:100%; width:100%; overflow:auto" >
	        		<div id="docDiv" style="height:100%;width:100%;overflow:hidden">
						...
						<textarea id='docPanel' readonly style="height:90%;width:90%" ondblclick="alert('dblOK')"
	...
	<input type='hidden' id='colNames' value='"""),_display_(/*343.45*/colNames),format.raw/*343.53*/("""'>
	<input type='hidden' id='colValues' value='"""),_display_(/*344.46*/colValues),format.raw/*344.55*/("""'>
