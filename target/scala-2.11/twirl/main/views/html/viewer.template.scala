...
<!-- 		</select> -->
	...
	<input type='hidden' id='colNames' value='"""),_display_(/*341.45*/colNames),format.raw/*341.53*/("""'>
	<input type='hidden' id='colValues' value='"""),_display_(/*342.46*/colValues),format.raw/*342.55*/("""'>
