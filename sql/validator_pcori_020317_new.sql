...
--
-- Host: localhost    Database: validator_pcori_020317
-- ------------------------------------------------------
...
CREATE TABLE `crf_project` (
  ...
  KEY `fk_crf_project_id_idx` (`project_id`),
  CONSTRAINT `fk_crf_project_id` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `crf_project_frame_instance`
--
...
-- Dump completed on 2017-02-06 14:23:02
